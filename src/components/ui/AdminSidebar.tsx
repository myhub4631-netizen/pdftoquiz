...
const adminNavItems = [
  ...
  { name: 'Processing Jobs', href: '/admin/jobs', icon: Cpu },
  { name: 'AI / OpenRouter', href: '/admin/ai', icon: Bot, highlight: true },
  ...
  return (
    <aside className="w-64 border-r border-slate-800/80 bg-slate-950 flex flex-col justify-between shrink-0 min-h-[calc(100vh-4rem)] p-4">
      <div className="space-y-6">
        {/* Admin Badge */}
        <div className="px-3 py-2 rounded-xl bg-indigo-950/40 border border-indigo-500/20">
